...
public class ClientTic extends Thread {
//Network
   ...
   public static  int player=0,player1=0,player2=0;
  static int buttonI[]=new int[9];
  static char button[]=new char[9];
  
	static JButton ButtonReset,Button1,Button2,Button3,Button4,Button5,Button6,Button7,Button8,Button9;
	static JLabel labelPlayerTurn;
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					ClientTic window = new ClientTic();
	...
	private void initialize() {
		...
		JLabel PLayer1Label = new JLabel(" Y O U -X");
		...
		JLabel Player2Label = new JLabel("OPPONENT-O");
		...
		ExitButton.setBounds(392, 220, 104, 57);
